...
During my undergraduate period, my research experience centered on applying computational methods to solve problems in physics. I began with a scientific initiation project in condensed matter, where I worked with a numerical model of temporal evolution of Nematic Liquid Crystals. Building on this foundation, my bachelor's thesis investigated the dynamics of the Double Harmonic Oscillator; for this, I developed C-based numerical solutions using the fourth-order Runge-Kutta method and analyzed frequency components with Fourier Transforms. These projects progressively solidified my skills in analytical modeling, numerical simulation, and scientific programming.
